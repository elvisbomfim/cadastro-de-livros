...
describe('Use Case DeletarAutor', function () {
    
    test('deve deletar um autor existente', function () {
        $repository = Mockery::mock(AutorRepositoryInterface::class);
        $useCase = new DeletarAutorUseCase($repository);
        
        $autorExistente = new Autor(
            nome: new Nome('Autor para Deletar'),
    ...
    test('deve deletar múltiplos autores diferentes com IDs diferentes', function () {
        $repository = Mockery::mock(AutorRepositoryInterface::class);
        $useCase = new DeletarAutorUseCase($repository);
        
        $autor1 = new Autor(
            nome: new Nome('Autor 1'),
            id: new Uuid('11111111-1111-1111-1111-111111111111')
        );
        
        $autor2 = new Autor(
            nome: new Nome('Autor 2'),
            id: new Uuid('22222222-2222-2222-2222-222222222222')
        );
        
        $autor3 = new Autor(
            nome: new Nome('Autor 3'),
    ...
    test('deve lançar exceção ao tentar deletar autor inexistente', function () {
        $repository = Mockery::mock(AutorRepositoryInterface::class);
        $useCase = new DeletarAutorUseCase($repository);
